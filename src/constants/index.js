...
const technologies = [
  { name: "Python (Advanced)", icon: backend },
  { name: "DSA", icon: web },
  { name: "C++ (Intermediate)", icon: backend },
  { name: "JavaScript (Intermediate)", icon: javascript },
  { name: "Version Control", icon: git },
  { name: "REST API design", icon: web },
  { name: "MySQL-Workbench", icon: mobile },
  { name: "Node.js", icon: nodejs },
  { name: "React.js", icon: reactjs },
  { name: "numpy", icon: backend },
  { name: "flask", icon: web },
  { name: "Firebase", icon: mobile },
  { name: "Supabase", icon: backend },
  { name: "Google Cloud", icon: docker },
  { name: "MongoDB", icon: mongodb },
  { name: "Communication", icon: html },
  { name: "Teamwork", icon: css },
  { name: "Adaptability", icon: tailwind },
  { name: "Leadership", icon: figma },
  { name: "Data Structures & Algorithms", icon: typescript },
  { name: "OOP", icon: redux },
  { name: "Web Development", icon: html },
  { name: "Data Analytics", icon: css },
  { name: "Cloud Computing", icon: docker },
  { name: "Software Development", icon: javascript },
